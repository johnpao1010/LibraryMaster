...
public class Usuario extends HLayout {
    ...
    public Usuario() {
        ...
        TextItem tiNombreUsuario = new TextItem("nombre_usu", "eee");
        ...
        TextItem tiApellidoUsuario = new TextItem("apellidos", "kdjkfd");
        ...
        TextItem tiUsuario = new TextItem("username", "dfdf");
        tiUsuario.setRequired(true);
        tiUsuario.setLength(32);

        PasswordItem piPwdUsuario = new PasswordItem("password", "dfdfs");
        piPwdUsuario.setRequired(true);
        piPwdUsuario.setLength(64);
        
        TextItem tiMailUsuario = new TextItem("email", "dfsd");
        ...
        //ListGrid de Usuario
        ListGridField gfUsuario = new ListGridField("username", "dfdfd");
        ListGridField gfEstadoUsuario = new ListGridField("id_estado", "dfsdf");
        ...
        //ListGrid de Usuario
        ListGridField gfNombreRol = new ListGridField("nombre_rol", "fsdf");
        ListGridField gfDescripcionRol = new ListGridField("descripcion", "dfd");
        ListGridField gfEstadoRol = new ListGridField("id_estado", "dfsdf");
...
//        cLMaster = new CLMaster("Usuario", formItems, gridFields, 2, VariablesGenerales.ETIQUETAS.usuario());
        ...
        //CON DRAG LIST
        cLMaster = new CLMaster("usuario", "rol", "rol_x_usuario", "fksld");
